...
contract OwnedDistributor is Ownable{
    ...
    uint public vestingAmount = 1100_000 * 10 ** 18;      // 1.1M STAR Initial vesting amount for users who deposit ASTAR
    ...
    constructor(address star_, uint vestingBegin_) {
        STAR = star_;
    ...
    function claimInternal(address account) internal virtual returns (uint amount) {
        ...
        if (amount > 0) {
            ...
            IERC20(STAR).transfer(account, amount);
